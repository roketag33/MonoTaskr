...
if (privacyLink) {
    privacyLink.addEventListener('click', (e) => {
        e.preventDefault();
        alert('Privacy Policy: MonoTaskr stores all data locally on your device. We do not collect, transmit, or share any of your personal information or usage data. Your focus sessions and settings remain completely private.');
    });
}
